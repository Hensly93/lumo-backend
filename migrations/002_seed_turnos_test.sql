...
INSERT INTO turnos_caja (
  ...
  (13, 14, 'Marta', 'tarde', 12200, 18350, 18250, -100, NOW() - INTERVAL '11 days' + INTERVAL '14 hours', NOW() - INTERVAL '11 days' + INTERVAL '20 hours', 'cerrado', false, false, false),
  ...
  (13, 14, 'Marta', 'tarde', 12050, 18100, 18150, 50, NOW() - INTERVAL '2 days' + INTERVAL '14 hours', NOW() - INTERVAL '2 days' + INTERVAL '20 hours', 'cerrado', false, false, false);
...
INSERT INTO turnos_caja (
  ...
  (13, 14, 'Carlos', 'tarde', 12100, 18050, 18000, -50, NOW() - INTERVAL '13 days' + INTERVAL '14 hours', NOW() - INTERVAL '13 days' + INTERVAL '20 hours', 'cerrado', false, false, false),
  ...
  (13, 14, 'Carlos', 'tarde', 11900, 17850, 17900, 50, NOW() - INTERVAL '7 days' + INTERVAL '14 hours', NOW() - INTERVAL '7 days' + INTERVAL '20 hours', 'cerrado', false, false, false),
...
INSERT INTO turnos_caja (
  ...
  (13, 14, 'Pedro', 'tarde', 12000, 17700, 18000, 300, NOW() - INTERVAL '24 days' + INTERVAL '14 hours', NOW() - INTERVAL '24 days' + INTERVAL '20 hours', 'cerrado', true, false, false),
  (13, 14, 'Pedro', 'tarde', 11900, 17500, 18000, 500, NOW() - INTERVAL '21 days' + INTERVAL '14 hours', NOW() - INTERVAL '21 days' + INTERVAL '20 hours', 'cerrado', false, true, false),
  (13, 14, 'Pedro', 'tarde', 12050, 17450, 18100, 650, NOW() - INTERVAL '15 days' + INTERVAL '14 hours', NOW() - INTERVAL '15 days' + INTERVAL '20 hours', 'cerrado', true, true, false),
  (13, 14, 'Pedro', 'tarde', 12100, 17400, 18200, 800, NOW() - INTERVAL '12 days' + INTERVAL '14 hours', NOW() - INTERVAL '12 days' + INTERVAL '20 hours', 'cerrado', true, false, false),
  (13, 14, 'Pedro', 'tarde', 12000, 17250, 18100, 850, NOW() - INTERVAL '9 days' + INTERVAL '14 hours', NOW() - INTERVAL '9 days' + INTERVAL '20 hours', 'cerrado', false, true, false),
  (13, 14, 'Pedro', 'tarde', 11950, 17150, 18050, 900, NOW() - INTERVAL '6 days' + INTERVAL '14 hours', NOW() - INTERVAL '6 days' + INTERVAL '20 hours', 'cerrado', true, true, false),
  (13, 14, 'Pedro', 'tarde', 12000, 17100, 18000, 900, NOW() - INTERVAL '3 days' + INTERVAL '14 hours', NOW() - INTERVAL '3 days' + INTERVAL '20 hours', 'cerrado', true, false, false),
